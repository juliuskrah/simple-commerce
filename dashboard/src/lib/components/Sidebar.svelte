...
<div class="h-full w-64 bg-white shadow-lg">
    <div class="flex items-center justify-center h-20 border-b">
        <div class="text-2xl font-bold text-primary-600">Shoperal</div>
    </div>
            ...
            {#each menuItems as item}
                <li class="mb-1">
                    <a 
                        ...
                        class="flex items-center px-6 py-3 {activeItem === item.id ? 'bg-primary-50 text-primary-600 border-r-4 border-primary-600' : 'text-gray-600 hover:bg-gray-100'}"
